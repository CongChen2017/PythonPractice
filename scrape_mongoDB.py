# the purpose is to scrape several websites collecting information
# about Mars. and then put information into MongoDB
...
def scrape():
	...
	# put all results together as a dictionary
	scrape_dic = {
